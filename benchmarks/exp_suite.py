...
LORA_DIR = {
        "S1": ["dummy-lora-7b-rank-8", "dummy-lora-7b-rank-16",
               "dummy-lora-7b-rank-32", "dummy-lora-7b-rank-64",
               "dummy-lora-7b-rank-128"],
...
paper_suite = {
    "default": BenchmarkConfig(
        ...
        cv = [1],
        duration = [1],
        input_range = [[500, 501]],# [[i, i+1] for i in range(100, 2001, 100)],
