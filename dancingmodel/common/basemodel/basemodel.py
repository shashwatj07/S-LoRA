...
from dancingmodel.common.basemodel.layer_weights.hf_load_utils import load_hf_weights
from dancingmodel.common.basemodel.infer_struct import InferStateInfo
...
class TpPartBaseModel:
    ...
    def _init_some_value(self):
        ...
        self.embed_dim_ = self.config["n_embed"]
        return
